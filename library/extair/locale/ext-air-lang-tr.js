...
if (Ext.air.Viewport) {
	Ext.apply(Ext.air.Viewport.prototype, {
		closeText: 'Kapat',
		restoreText: 'Önceki Boyut',
		minimizeText: 'Aş. Geri Getir',
		maximizeText: 'Ekranı Kapla',
	});
}
...
if (Ext.form.htmleditor.AlignmentPlugin) {
	Ext.apply(Ext.form.htmleditor.AlignmentPlugin.prototype.tips, {
		justifyLeft: {
			title: 'Sola Hizala',
			text: 'Metni sola hizalar.'
		},
		justifyCenter: {
			title: 'Merkeze Hizala',
			text: 'Metni merkeze hizalar.'
		},
		justifyRight: {
			title: 'Sağa Hizala',
			text: 'Metni sağa hizalar.'
		},
		justifyFull: {
			title: 'Hizala',
